...
function setDefaultRememberme() {
    // lấy ra thông tin rememberMe trong storage
    var isRememberMe = storage.getRememberMe();
    // nhập thông tin rememberMe trong storage
...
function callLoginAPI(username, password) {
    ...
    $.ajax({
        ...
        // yêu cầu check quyền truy cập đến chức năng
        ...
        success: function (data, textStatus, xhr) {
            ...
            storage.setItem("GENDER", data.gender);
